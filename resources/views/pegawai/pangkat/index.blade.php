...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            ...
            <a href="{{ route('pangkat-golongan.create') }}">
                <button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    <a href="{{ route('pangkat-golongan.detail', ['id' => $golongan->id]) }}"
                                                    ...
                                                    <a href="{{ route('pangkat-golongan.edit', ['id' => $golongan->id]) }}"
                                                    ...
                                                    <form
                                                    action="{{ route('pangkat-golongan.delete', ['id' => $golongan->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
