    ...
    <div class="container">
        <div class="max-w-2xl px-4  sm:px-6 lg:px-8  mx-auto">
            ...
            <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                ...
                <form method="POST" action="{{ route('tes.update',['id' => $tes->id ])  }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div
                        ...
                        <div class="mt-2 space-y-3">
                            <input name="nama_tes" type="text" value="{{ $tes->nama_tes }}"
                        ...
                        <div class="mt-2 space-y-3">
                            <input name="skor" type="text" value="{{ $tes->skor }}"
                                class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                placeholder="skor">
                        </div>
                        ...
                        <select name="jenis_tes" value="{{ $tes->jenis_tes }}"
                        ...
                        <div class="mt-2 space-y-3">
                            <input name="penyelenggara" type="text" value="{{ $tes->penyelenggara }}"
                                class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                        ...
                        <div class="mt-2 space-y-3">
                            <input name="tahun" type="text" value="{{ $tes->tahun}}"
                                class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
