                        ...
                        <div class="mt-2 space-y-3">
                            ...
                            <div>
                                ...
                                <select name="role" value="{{ $user->role }}"
                                    ...
                                    <option {{ $user->role == 'admin' ? 'selected' : 'disabled' }} value="admin">Admin
                                    </option>
                                    <option {{ $user->role == 'admin-pegawai' ? 'selected' : 'disabled' }}
                                        value="admin-pegawai">Admin-Pegawai
                                    </option>
                                    <option {{ $user->role == 'pegawai' ? 'selected' : 'disabled' }} value="pegawai">
                                        Pegawai</option>
                                    <option {{ $user->role == 'wadir' ? 'selected' : 'disabled' }} value="wadir">Wadir
                                    </option>
                                </select>
                            </div>
