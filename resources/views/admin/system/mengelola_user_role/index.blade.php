...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">Mengelola User Role</p>
                                    ...
                                    <div class="grid gap-y-4">
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <select name="penerima_id[]" id="pegawaiSelect" multiple
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach ($usersWithRoles as $role)
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                            <ul class="list-disc">
                                                @foreach ($role->roles  as $permission)
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                            <div class="flex justify-end">
                                                ...
                                                {{-- <form action="{{ route('mengelola-user-role.delete', ['id' => $role->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
