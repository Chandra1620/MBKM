...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">Mengelola Role</p>
            <div class="text-center">
                <button type="button"
                    class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    data-hs-overlay="#hs-modal-create-role">
                    Buat
                </button>
            </div>

            <div id="hs-modal-create-role"
                ...
                <div
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-4 sm:p-7">
                            <div class="text-center">
                                <h2 class="block text-2xl font-bold text-gray-800 dark:text-gray-200">Buat Role</h2>
                            ...
                            <div class="mt-5">
                                <!-- Form -->
                                <form method="POST" action="{{ route('mengelola-role.store') }}">
                                    @csrf
                                    <div class="grid gap-y-4">
                                        <!-- Form Group -->
                                        <div>
                                            <label for="nama_role" class="block text-sm mb-2 dark:text-white">nama
                                                role</label>
                                            <div class="relative">
                                                <input id="nama_role" name="nama_role"
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Role</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Permission</th>
                                            ...
                                            <div class="flex justify-end">
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        ...
                                                        {{ $role->name == 'admin-pegawai' ? 'disabled' : '' }}
                                                    type="button"
                                                        ...
                                                        data-hs-overlay="#update-role-permission-{{ $role->id }}">
                                                        Pilih Permission
                                                    </button>

                                                </div>

                                                <div id="update-role-permission-{{ $role->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="p-4 sm:p-7">
                                                                ...
                                                                <div class="mt-5">
                                                                    <!-- Form -->
                                                                    <form action="{{ route('mengelola-role-permission.update', ['id' => $role->id]) }}" method="POST">
                                                                        @csrf
                                                                        @method('put')
                                                                        <div class="grid gap-y-4">
                                                                            <!-- Form Group -->
                                                                            <div class="flex flex-wrap gap-x-6">
                                                                                @foreach ($allpermission as $item)
                                                                                    <div class="flex">
                                                                                        ...
                                                                                        <label for="hs-checkbox-group-{{ $item->id }}" class="text-sm text-gray-500 ms-3 dark:text-gray-400">
                                                                                            {{ $item->name }}
                                                                                        </label>
                                                                                    </div>
                                                                                @endforeach
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    {{ $role->name == 'admin-pegawai' ? 'disabled' : '' }}
                                                        ...
                                                        class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-blue-600 text-blue-600 hover:border-blue-500 hover:text-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                                        data-hs-overlay="#hs-modal-recover-account-{{ $role->id }}">
                                                        Edit Role
                                                    </button>

                                                </div>

                                                <div id="hs-modal-recover-account-{{ $role->id }}"
                                                    class="hs-overlay hidden w-full h-full fixed top-0 start-0 z-[60] flex items-center overflow-x-hidden overflow-y-auto">
                                                    <div
                                                        class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all w-full sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                                                        <div
                                                            ...
                                                            <div class="p-4 sm:p-7">
                                                                ...
                                                                <div class="mt-5">
                                                                    <!-- Form -->
                                                                    <form
                                                                        action="{{ route('mengelola-role.update', ['id' => $role->id]) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('put')
                                                                        <div class="grid gap-y-4">
