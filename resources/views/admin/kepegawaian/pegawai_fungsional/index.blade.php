                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($riwayat_fungsional as $item)
                                        <tr>
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                {{ $item->jabatanfungsional->name }}</td>

                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                {{ $item->jabatanfungsional->unitkerja->name }}</td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                {{ $item->tanggal_mulai }}</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    <form
                                                    action="{{ route('pegawai-fungsional.verifikasi', ['id' => $item->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('post')
                                                ...
                                                <form action="{{ route('pegawai-fungsional.tolakVerifikasi', ['id' => $item->id]) }}">
                                                    @csrf
