...
@section('content')
    <div class="container">
        <div class="max-w-2xl px-4  sm:px-6 lg:px-8  mx-auto">
            ...
            <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                <div class="text-center mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200">
                        Form Update Pangkat dan Golongan
                    </h2>
                ...
                <form method="POST" action="{{ route('admin-pangkat-golongan.update', ['id' => $pangkatGolongan->id]) }}"
                    ...
                    <div id="personal">
                        ...
                        <div class="mt-2 space-y-3">
                            <input id="recipient-search" type="text"
                                ...
                                placeholder="{{ $pangkatGolongan->user->name }}">
                        </div>
                        ...
                        <input type="hidden" name="selected_recipients" id="selected-recipients-input" value="{{ $pangkatGolongan->user->name }}">
                        <input type="hidden" name="usersSelected" id="usersSelected" value="{{ $pangkatGolongan->user->name }}">
                    </div>
                    ...
                    <script>
                        ...
                        // Fungsi untuk memeriksa apakah pengguna adalah nama pegawai default
                        function isDefaultUser(user) {
                            return user.name === "{{ $pangkatGolongan->user->name }}";
                        }
                            ...
                            fetch(`/admin-kepegawaian/management-surat-keputusan/searchuser?input=${userInput}`)
                                ...
                                .then(data => {
                                    ...
                                    data.forEach(user => {
                                        ...
                                        // Cek apakah pengguna adalah nama pegawai default
                                        ...
                                        userDiv.addEventListener('click', () => {
                                            ...
                                            if (list === "{{ $pangkatGolongan->user->name }}") {
                    ...
                    <div
                        ...
                        <select name="pangkat_golongan" id="pangkatGolongan"
                            ...
                            <option disabled selected value="{{ $pangkatGolongan->pangkat_golongan }}">
                                {{ $pangkatGolongan->pangkat_golongan }}</option>
                        </select>
                    </div>
                    ...
                    <script>
                        ...
                        function populateDropdown() {
                            ...
                            for (var i = 0; i < pangkatGolonganData.length; i++) {
                                ...
                                if (pangkatGolonganData[i] === "{{ $pangkatGolongan->pangkat_golongan }}") {
                                    option.selected = true;
                                }
                                dropdown.add(option);
                            }
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="nomor_sk" type="text"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Nomor SK" value="{{ $pangkatGolongan->nomor_sk }}">
                    </div>
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="tanggal_sk" type="date" id="tanggalMulai"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Tanggal SK" value="{{ $pangkatGolongan->tanggal_sk }}">
                    </div>
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="tanggal_mulai" type="date" id="tanggalMulai"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Terhitung Mulai Tanggal" value="{{ $pangkatGolongan->tanggal_mulai }}">
                    </div>
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="kredit" type="text"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Angka Kredit" value="{{ $pangkatGolongan->kredit }}">
                    </div>
                    <label class="inline-block text-sm font-medium dark:text-white">
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="masakerja_tahun" type="text"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Masa Kerja Golongan" value="{{ $pangkatGolongan->masakerja_tahun }}">
                    </div>
                    <label class="inline-block text-sm font-medium dark:text-white">
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="masakerja_bulan" type="text"
                            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            placeholder="Masa Kerja Golongan" value="{{ $pangkatGolongan->masakerja_bulan }}">
                    </div>
            </div>
            ...
            <div class=" space-y-3">
                <label class="block">
                    <span class="sr-only">{{ $pangkatGolongan->dokumen_pendukung }}</span>
                    <input name="dokumen_pendukung" type="file"
                        ...
                        value="{{ $pangkatGolongan->dokumen_pendukung }}" />
                </label>
