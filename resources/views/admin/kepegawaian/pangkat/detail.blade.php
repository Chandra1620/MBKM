                ...
                <div
                    ...
                    <div class="mt-2 space-y-3">
                        <input name="nomor_sk" type="text"
                            ...
                            placeholder="Nomor SK" value="{{ $pangkatGolongan->user->name }}" disabled>
                    </div>
                </div>
                <label class="inline-block text-sm font-medium dark:text-white">
                        Pangkat/Golongan
            ...
            <div class=" space-y-3">
                ...
                <div class="flex space-x-2 items-center">
                    <input name="dokumen_pendukung" type="text"
                        ...
                        value="{{ $pangkatGolongan->dokumen_pendukung }}" disabled />

                    <a href="{{ route('admin-pangkat-golongan.download', ['id' => $pangkatGolongan->id]) }}"
                ...
                {{-- button --}}
                @if ($pangkatGolongan->status == 'pengajuan')
                    <form action="{{ route('admin-pangkat-golongan.verifikasi', ['id' => $pangkatGolongan->id]) }}" method="POST">
                        @csrf
                        @method('post')

                        <input type="hidden" name="user_id" value="{{ $pangkatGolongan->user_id }}">
                        <button type="submit"
                    ...
                    <form action="{{ route('admin-pangkat-golongan.tolak_verifikasi', ['id' => $golongan->id]) }}"
                        method="POST">
                        @csrf
                        @method('post')
                        ...
                        <button type="submit"
                            ...
                            <svg class="h-10 w-10 text-white" width="24" height="24" viewBox="0 0 24 24"
                ...
                <div class="mt-5 flex justify-end gap-x-2">
                    <a href="{{ route('admin-pangkat-golongan.index') }}">
                        <button type="button"
