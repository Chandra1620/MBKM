...
@section('content')
    <div class="container">
        <div>
            <p class="pb-1 font-bold">Update Riwayat Pendidikan Formal</p>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-4 sm:p-7">
                            ...
                            <div class="mt-5">
                                ...
                                <!-- Form -->
                                <form method="POST" action="{{ route('pendidikanformal.store') }}">
                                    @csrf
                                    <div class="grid gap-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="date" id="tanggal_sk_penyetaraan"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    @if ($user->status == 'pengajuan')
                                                        <form
                                                            action="{{ route('update-pendidikanformal.verifikasi', ['id' => $user->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')
                                                            ...
                                                            <input type="hidden" name="user_id"
                                                                value="{{ $user->user_id }}">
                                                            <button type="submit"
                                                                {{ $user->status != 'pengajuan' ? 'disabled' : '' }}
                                                                class="
                                                        ...
                                                        <form
                                                            action="{{ route('update-pendidikanformal.ditolak', ['id' => $user->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')
