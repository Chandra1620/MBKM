...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">UPDATE PELATIHAN</p>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Peran
                                        </th>
                                        ...
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tempat
                                        </th>
                                        <th scope="col"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    @if ($pelatihan->status == 'pengajuan')
                                                        <form
                                                            action="{{ route('update-pelatihan.verifikasi', ['id' => $pelatihan->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')

                                                            <input type="hidden" name="user_id"
                                                                value="{{ $pelatihan->user_id }}">
                                                            <button type="submit"
                                                                {{ $pelatihan->status != 'pengajuan' ? 'disabled' : '' }}
                                                                class="
                                                        ...
                                                        <form
                                                            action="{{ route('update-pelatihan.ditolak', ['id' => $pelatihan->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')
