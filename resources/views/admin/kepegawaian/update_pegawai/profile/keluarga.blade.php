...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">UPDATE KELUARGA</p>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status Perkawinan
                                        </th>

                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Pasangan
                                        </th>

                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Pekerjaan Pasangan
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($riwayat_fungsional as $item)
                                        <tr>
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                {{ $item->nama_pasangan }}</td>

                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                {{ $item->pekerjaan_pasangan }}</td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    <form
                                                        action="{{ route('update-keluarga.verifikasi', ['id' => $item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('post')
                                                    ...
                                                    <form
                                                        action="{{ route('update-keluarga.ditolak', ['id' => $item->id]) }}"
                                                        method="POST"
