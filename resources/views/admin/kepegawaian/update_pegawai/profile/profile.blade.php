                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Ibu
                                        </th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    <form
                                                        action="{{ route('update-profile.verifikasi', ['id' => $item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('post')
                                                    ...
                                                    <form
                                                        action="{{ route('update-profile.ditolak', ['id' => $item->id]) }}"
                                                        method="POST"
