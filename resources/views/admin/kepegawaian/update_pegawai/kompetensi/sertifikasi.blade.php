...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">Riwayat Sertifikasi</p>
                        ...
                        <div class="py-3 px-4">
                            <div class="relative max-w-xs">
                                ...
                                <input type="text" name="hs-table-with-pagination-search"
                                    ...
                                    placeholder="Cari Nama Seritifikasi ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    ...
                                                    @if ($sertif->status == 'pengajuan')
                                                        <form
                                                            action="{{ route('update-sertifikasi.verifikasi', ['id' => $sertif->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')

                                                            <input type="hidden" name="user_id"
                                                                value="{{ $sertif->user_id }}">
                                                            <button type="submit"
                                                                {{ $sertif->status != 'pengajuan' ? 'disabled' : '' }}
                                                                class="
                                                        ...
                                                        <form
                                                            action="{{ route('update-sertifikasi.ditolak', ['id' => $sertif->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('post')
