        ...
        <div class="flex justify-between"> <!-- Tambahkan class flex justify-between di sini -->
            ...
            @if ($surat->jenis_surat == 'STPD')
                <div class="ml-auto"> <!-- Tambahkan class ml-auto di sini -->
                    <a href="@if ($surat->jenis_surat == 'STPD') {{ route('export.stpd', ['id' => $surat->id]) }}
                    @elseif ($surat->jenis_surat == 'ST')
                    ...
                    {{ route('download.sk', ['id' => $surat->id]) }} @endif"
                        ...
                        <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            @if ($surat->jenis_surat == 'ST')
                                                ...
                                                <tr>
                                                    <th scope="row" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                                        Anggota
                                                    </th>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                        @forelse ($anggotaBrimob as $user)
                                                            {{ $user->name }}<br>
                                                        @empty
                                            ...
                                            @if ($surat->jenis_surat == 'STPD' || $surat->jenis_surat == 'ST')
                                                <tr>
                                                    @php
                                                        ...
                                                        $tanggalBerangkat = \Carbon\Carbon::parse(
                                                            $surat->tgl_berangkat,
                                                        );
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="@if ($surat->jenis_surat == 'STPD') {{ route('download.file-stpd', ['id' => $surat->id]) }}
                                                            @elseif ($surat->jenis_surat == 'ST')
                                                            {{ route('management-surat-tugas.download', ['id' => $surat->id]) }}
                                                            @elseif ($surat->jenis_surat == 'SK')
                                                            {{ route('download.sk', ['id' => $surat->id]) }} @endif"
