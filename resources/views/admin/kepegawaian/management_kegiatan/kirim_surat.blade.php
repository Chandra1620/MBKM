...
@section('content')
    ...
    <div class="container">
        <div>
            <p class="pb-1 font-bold">Management Surat</p>
            <div class="">
                <button type="button"
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-4 sm:p-7">
                            ...
                            <div class="mt-5">
                                ...
                                <!-- Form -->
                                <form method="POST" action="{{ route('management-surat.store') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @if ($log->jenis_surat == $jenisSurat)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                <a target="_blank"
                                                    href="{{ url('document/' . $log->file_pendukung) }}">
                                                    <button type="button" class="py-1 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-white text-gray-800 hover:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                                    Lihat</button></a>
                                                {{-- @if ($log->penerima)
                                                    @foreach ($log->penerima as $penerima)
                                                        <p>Penerima: {{ $penerima->name }}</p>
                                                    @endforeach
                                                @endif --}}
