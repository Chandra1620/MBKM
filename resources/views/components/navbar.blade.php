<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
    <nav class="relative flex flex-wrap basis-full items-center w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
      
    <div class="flex items-center justify-between w-full">
        <div>
          <a class="flex-none text-xl font-semibold dark:text-white lg:hidden " href="#" aria-label="Brand">Polindra</a>
        </div>

        
        <div class="hs-dropdown relative inline-flex border-none">
