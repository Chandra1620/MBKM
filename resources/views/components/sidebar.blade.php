    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
                ...
                {{-- <li class="hs-accordion" id="users-accordion">
                    ...
                    <div id="projects-accordion"
                        ...
                        <ul class="pt-2 pl-2">
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('mengelola-role.index') }}"
                                    >
                                    Role
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('mengelola-permission.index') }}"
                                    >
                                    Permission
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('mengelola-user-role.index') }}"
                                    >
                                    User Role
                                </a>
                            </li>
                ...
                <li class="hs-accordion" id="account-accordion">
                    <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="-m-1  w-5 h-5">
                    ...
                    <div id="account-accordion"
                        ...
                        <ul class="pt-2 pl-2">
                            ...
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('diklat.index') }}">
                                    Pelatihan
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('riwayat-pekerjaan.index') }}">
                                    Riwayat Pekerjaan
                                </a>
                            </li>
                        </ul>
            ...
            @if (count(Auth::user()->roles) > 0)
                ...
                @endcan
                {{-- @endif --}}
                @can(['mengelola-jabatan-struktural', 'mengelola-pegawai-struktural', 'mengelola-pegawai-fungsional',
                    ...
                    <li class="hs-accordion" id="users-accordion">
                        ...
                        <div id="projects-accordion"
                            ...
                            <ul class="pt-2 pl-2">
                                ...
                                @endcan
                                @can('mengelola-jabatan-struktural')
                                    <li>
                                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                ...
                                @endcan
                                @can('mengelola-pegawai-struktural')
                                    <li>
                                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                ...
                                @endcan
                                @can('mengelola-pegawai-fungsional')
                                    <li>
                                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                ...
                                @endcan
                                @can('mengelola-pangkat-golongan')
                                    <li>
                                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                            href="{{ route('admin-pangkat-golongan.index') }}">
                                            Pangkat Golongan
                                        </a>
                                    </li>
                                @endcan
                ...
                <li>
                    <a class="{{ request()->is('perizinan-manual') ? 'bg-gray-100 flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-900 dark:text-white' : 'flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-900 dark:text-white' }}"
                        href="{{ route('perizinan-manual.index') }}">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
            ...
            @endif --}}
            @if (Auth::user()->role_khusus_1 == 'Wadir')
                <li>
                    <p class="border-t border-gray-200 border-t-1 mt-4 pt-4">WADIR</p>
                </li>
                <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-md hover:bg-gray-100 dark:bg-gray-900 {{ request()->is('management-perizinan') ? 'bg-gray-100 text-slate-700 dark:text-white' : 'text-slate-700 dark:text-white' }}"
                        href="{{ route('management-perizinan-lanjutan.index') }}">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                        ...
                        Keputusan Perizinan Pegawai
                    </a>
                </li>
            @endif
            @if (Auth::user()->role_khusus_2 == 'Atasan Langsung')
                <li>
                    <p class="border-t border-gray-200 border-t-1 mt-4 pt-4">ATASAN LANGSUNG</p>
                </li>
                <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-md hover:bg-gray-100 dark:bg-gray-900 {{ request()->is('management-perizinan') ? 'bg-gray-100 text-slate-700 dark:text-white' : 'text-slate-700 dark:text-white' }}"
                        href="{{ route('management-perizinan-atasan.index') }}">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
