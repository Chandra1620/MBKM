                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="p-4 sm:p-7">
                                                                        ...
                                                                        <div class="mt-5">
                                                                            ...
                                                                            <!-- Form -->
                                                                            <form method="POST"
                                                                                action="{{ route('management-perizinan-lanjutan.verifikasi', ['id_perizinan' => $item->perizinan_cuti_id, 'id_pegawai' => $item->user_id]) }}" enctype="multipart/form-data">
                                                                                @csrf
                                                                                @method('POST')
                                                                                <div class="text-left">
                                                    ...
                                                    <a href="{{ route('perizinan-cuti-atasan.pdfStream', ['id' => $item->user_id, "id_perizinan" => $item->perizinan_cuti_id]) }}"
