...
<body>
    ...
    <div class="flex justify-center">
        <!-- Grid -->
        <div class="container">
            <div class="mx-2 grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center mt-[80px] xsm:mt-0">
                <div data-aos="fade-right" data-aos-delay="300" class="order-2 md:order-1">
                    <h1
                        class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                        SISTEM INFORMASI KEPEGAWAIAN <span class="text-blue-600">POLITEKNIK NEGERI INDRAMAYU</span></h1>
                    {{-- <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Hand-picked professionals and expertly
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-1 gap-x-5">
                        ...
                        <div class="py-5">
                            ...
                            <p class="text-2xl text-gray-800 dark:text-gray-200">
                                <span class="font-bold">Sistem Informasi Kepegawaian Politeknik Negeri Indramayu </span>adalah Sistem yang mengelola Data Diri Pegawai, Proses Perizinan, Monitoring Presensi dan juga Persuratan.
                            </p>
                ...
                <div data-aos="fade-up" data-aos-delay="300" data-aos-anchor-placement="bottom-bottom"
                    class="relative ml-4 order-1 md:order-2 ">
                    {{-- <div class="h-[200px]"></div> --}}
                    <img class="w-full rounded-md" src="{{ asset('assets/image/gsc-polindra.jpg') }}" alt="gsc">
                    <div
                    ...
                    <div class="absolute bottom-0 left-0">
                        <svg class="w-2/3 ml-auto h-auto text-white dark:text-slate-900" width="630"
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
                <div class="text-center">
                    <img class="rounded-xl sm:w-48 sm:h-48 lg:w-60 lg:h-60 mx-auto"
